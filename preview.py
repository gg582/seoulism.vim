...
def draw_seoulism_blueprint():
    ...
    mapping = [
        ...
        {"id": "fg", "tag": "BASE",   "hex": "#b6b598", "element": "CORE",    "logic": "Content / Neutral"},
    ...
    ax.text(10, 92, "SEOULISM: Systemic Cognitive Mapping",
            color='#b6b598', fontsize=20, ha='left', weight='bold')
    ...
    for i, item in enumerate(mapping):
        ...
        # Technical Labels
        ax.text(16, y + 3, item['id'].upper(), color='#b6b598',
        ...
        ax.text(40, y + 1.5, f"LOGIC: {item['logic']}",
                color='#b6b598', fontsize=11, va='center', alpha=0.8)
