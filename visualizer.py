...
def draw_seoulism_chain():
    ...
    for node, (x, y) in pos.items():
        ...
        if stage_idx in [2, 3]:
            ...
            text_color = '#181a1f' if (0.2126*int(hex_color[1:3],16) + 0.7152*int(hex_color[3:5],16) + 0.0722*int(hex_color[5:7],16)) > 135 else '#b6b5a8'
        else:
            text_color = '#d7d6d2'
    ...
    plt.title("Systemic Cognitive Mapping: From Elemental Logic to Seoulism", 
              color='#b6b5a8', fontsize=15, pad=40, fontweight='bold')
