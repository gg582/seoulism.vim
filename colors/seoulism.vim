...
" Tweaks: strings -> yellow, subtle desaturation (bg unchanged), red/purple use-case swapped
...
if has('nvim')
  try
    execute 'hi DiagnosticUnderlineError gui=undercurl guisp=#c582ed'
    execute 'hi DiagnosticUnderlineWarn  gui=undercurl guisp=#fcc06b'
    execute 'hi DiagnosticUnderlineInfo  gui=undercurl guisp=#5db2dc'
    execute 'hi DiagnosticUnderlineHint  gui=undercurl guisp=#56d9b9'
  catch
  endtry
endif
...
call s:hi('Constant', '#5db2dc', 'NONE', '74', 'NONE', 'NONE')
call s:hi('String', '#fb9f42', 'NONE', '215', 'NONE', 'NONE')
call s:hi('Character', '#fcc06b', 'NONE', '215', 'NONE', 'NONE')
call s:hi('Number', '#fb9f42', 'NONE', '215', 'NONE', 'NONE')
call s:hi('Boolean', '#fcc06b', 'NONE', '215', 'NONE', 'NONE')
call s:hi('Float', '#fb9f42', 'NONE', '215', 'NONE', 'NONE')
call s:hi('Identifier', '#ecece9', 'NONE', '255', 'NONE', 'NONE')
call s:hi('Function', '#5bbfb0', 'NONE', '73', 'NONE', 'NONE')
call s:hi('Statement', '#e5483a', 'NONE', '167', 'NONE', 'NONE')
call s:hi('Conditional', '#e5483a', 'NONE', '167', 'NONE', 'NONE')
call s:hi('Repeat', '#e5483a', 'NONE', '167', 'NONE', 'NONE')
call s:hi('Label', '#eb6c65', 'NONE', '203', 'NONE', 'NONE')
call s:hi('Operator', '#ecece9', 'NONE', '255', 'NONE', 'NONE')
call s:hi('Keyword', '#e5483a', 'NONE', '167', 'NONE', 'NONE')
call s:hi('Exception', '#9c5fe8', 'NONE', '134', 'NONE', 'NONE')
call s:hi('PreProc', '#2f9cd3', 'NONE', '38', 'NONE', 'NONE')
call s:hi('Include', '#5db2dc', 'NONE', '74', 'NONE', 'NONE')
call s:hi('Define', '#2f9cd3', 'NONE', '38', 'NONE', 'NONE')
call s:hi('Macro', '#2f9cd3', 'NONE', '38', 'NONE', 'NONE')
call s:hi('PreCondit', '#2f9cd3', 'NONE', '38', 'NONE', 'NONE')
call s:hi('Type', '#315ee2', 'NONE', '62', 'NONE', 'NONE')
call s:hi('StorageClass', '#315ee2', 'NONE', '62', 'NONE', 'NONE')
call s:hi('Structure', '#315ee2', 'NONE', '62', 'NONE', 'NONE')
call s:hi('Typedef', '#315ee2', 'NONE', '62', 'NONE', 'NONE')
call s:hi('Special', '#9c5fe8', 'NONE', '134', 'NONE', 'NONE')
call s:hi('SpecialChar', '#fcc06b', 'NONE', '215', 'NONE', 'NONE')
call s:hi('Tag', '#5db2dc', 'NONE', '74', 'NONE', 'NONE')
...
call s:hi('Underlined', '#5db2dc', 'NONE', '74', 'NONE', 'underline')
call s:hi('Ignore', '#464e56', 'NONE', '239', 'NONE', 'NONE')
call s:hi('Error', '#c582ed', '#101114', '177', '233', 'bold')
call s:hi('Todo', '#101114', '#fb9f42', '233', '215', 'bold')
...
call s:hi('CursorLineNr', '#fcc06b', '#242630', '215', '235', 'bold')
...
call s:hi('ErrorMsg', '#c582ed', '#101114', '177', '233', 'bold')
call s:hi('WarningMsg', '#fcc06b', '#101114', '215', '233', 'bold')
call s:hi('MoreMsg', '#56d9b9', 'NONE', '79', 'NONE', 'bold')
call s:hi('ModeMsg', '#e7e7e4', 'NONE', '254', 'NONE', 'bold')
call s:hi('Question', '#fb9f42', 'NONE', '215', 'NONE', 'bold')
call s:hi('QuickFixLine', '#101114', '#27769e', '233', '31', 'bold')
call s:hi('DiffAdd', '#ecece9', '#2848a8', '255', '25', 'NONE')
call s:hi('DiffChange', '#ecece9', '#315ee2', '255', '62', 'NONE')
call s:hi('DiffDelete', '#ecece9', '#aa3e2e', '255', '130', 'NONE')
call s:hi('DiffText', '#101114', '#5e81e9', '233', '68', 'bold')
...
call s:hi('DiagnosticError', '#c582ed', 'NONE', '177', 'NONE', 'NONE')
call s:hi('DiagnosticWarn', '#fcc06b', 'NONE', '215', 'NONE', 'NONE')
call s:hi('DiagnosticInfo', '#5db2dc', 'NONE', '74', 'NONE', 'NONE')
call s:hi('DiagnosticHint', '#56d9b9', 'NONE', '79', 'NONE', 'NONE')
call s:hi('DiagnosticOk', '#fb9f42', 'NONE', '215', 'NONE', 'NONE')
